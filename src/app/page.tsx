...
export default async function HomePage() {
  ...
  return (
    <main className="flex flex-1 flex-col items-center gap-10 px-4 py-10 sm:gap-14 sm:py-16">
      ...
      <section className="grid w-full max-w-3xl grid-cols-1 gap-8 divide-y divide-hairline sm:grid-cols-3 sm:gap-0 sm:divide-x sm:divide-y-0">
        ...
        <div className="flex flex-col items-center gap-3 px-6 pt-8 text-center sm:pt-0">
          ...
          <h3 className="font-display text-[17px] font-extrabold tracking-tight">Pick</h3>
